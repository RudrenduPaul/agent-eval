...
def test_mann_whitney_n50(
    benchmark: object, scores_50: tuple[list[float], list[float]]
) -> None:
    a, b = scores_50
...
def test_mann_whitney_n1000(
    benchmark: object, scores_1000: tuple[list[float], list[float]]
) -> None:
    a, b = scores_1000
    result = benchmark(mann_whitney_u, a, b)  # type: ignore[operator]
    assert result.p_value < 1.0
