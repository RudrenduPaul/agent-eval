...
If you use agentregress in research, please cite:

```bibtex
@software{paul2026agentregress,
...
Methodology pre-print: [docs/[redacted]](docs/[redacted]) (arXiv submission pending).
